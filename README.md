# 급여 정산 관리 시스템 (Commute Pay Calculator)
...
1. **저장소 클론:**
   ```bash
   git clone https://github.com/comingsoon-lee/commute-pay-app.git
   cd commute-pay-app
   ```
...
버그 리포트나 기능 제안은 [Issues](https://github.com/comingsoon-lee/commute-pay-app/issues) 탭을 이용해 주시고, 코드 기여를 원하신다면 Pull Request를 남겨주시면 감사하겠습니다.
